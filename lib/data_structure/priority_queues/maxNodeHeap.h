...
class maxNodeHeap : public priority_queue_interface {
        public:
                ...
                void decreaseKey(NodeID node, NodeWeight gain);
                void increaseKey(NodeID node, NodeWeight gain);
                void changeKey(NodeID node, NodeWeight gain);
                NodeWeight getKey(NodeID node);
...
inline NodeWeight maxNodeHeap::maxValue() {
...
inline void maxNodeHeap::insert(NodeID node, NodeWeight gain) {
...
inline void maxNodeHeap::changeKey(NodeID node, NodeWeight gain) {
        NodeWeight old_gain = m_heap[m_elements[m_element_index[node]].get_index()].first;
        if( old_gain > gain ) {
...
inline void maxNodeHeap::decreaseKey(NodeID node, NodeWeight gain) {
...
inline void maxNodeHeap::increaseKey(NodeID node, NodeWeight gain) {
        ASSERT_TRUE(m_element_index.find(node) != m_element_index.end());
        int queue_idx = m_element_index[node]; 
        int heap_idx  = m_elements[queue_idx].get_index();
        m_elements[queue_idx].set_key(gain);
...
inline NodeWeight maxNodeHeap::getKey(NodeID node) {
