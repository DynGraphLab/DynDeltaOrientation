#ifndef DELTA_ORIENTATIONS_RWALKMAX_H
#define DELTA_ORIENTATIONS_RWALKMAX_H
...
class dyn_edge_orientation_RWalkMax : public dyn_edge_orientation {
        public:
                dyn_edge_orientation_RWalkMax(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
