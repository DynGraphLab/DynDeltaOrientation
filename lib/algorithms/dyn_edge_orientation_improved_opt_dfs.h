#ifndef DELTA_ORIENTATIONS_improved_opt_dfs_H
#define DELTA_ORIENTATIONS_improved_opt_dfs_H
...
class dyn_edge_orientation_improved_opt_dfs : public dyn_edge_orientation {
public:
  dyn_edge_orientation_improved_opt_dfs(
...
private:
  ...
  bool dfs_forward(NodeID source);
  bool dfs_backward(NodeID target);
  bool dfs_forward_correct(NodeID source);
  bool dfs_backward_correct(NodeID target);
  bool dfs_forward_correct_2(NodeID source);
  bool dfs_backward_correct_2(NodeID target);
  bool dfs_forward_shared_visited(NodeID source, std::vector<NodeID> &touched);
  void find_optimal();
  void find_optimal_shared_visited();
  bool dfs_forward_shared_visited_correct_2(NodeID source, std::vector<NodeID> &touched);
  void find_optimal_shared_visited_correct_2();
