...
dyn_edge_orientation_impro_opt::dyn_edge_orientation_impro_opt(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
...
void dyn_edge_orientation_impro_opt::handleInsertion(NodeID source, NodeID target) {
...
void dyn_edge_orientation_impro_opt::handleDeletion(NodeID source, NodeID target) {
...
void dyn_edge_orientation_impro_opt::bfs(NodeID source) {
