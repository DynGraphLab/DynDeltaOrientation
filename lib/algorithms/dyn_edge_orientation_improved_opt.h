#ifndef DELTA_ORIENTATIONS_improved_opt_H
#define DELTA_ORIENTATIONS_improved_opt_H
...
class dyn_edge_orientation_improved_opt : public dyn_edge_orientation {
public:
  dyn_edge_orientation_improved_opt(
...
private:
  ...
  bool bfs_forward(NodeID source);
  bool bfs_backward(NodeID target);
  void find_optimal();
