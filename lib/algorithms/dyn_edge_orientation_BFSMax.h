#ifndef DELTA_ORIENTATIONS_BFSMax_H
#define DELTA_ORIENTATIONS_BFSMax_H
...
class dyn_edge_orientation_BFSMax : public dyn_edge_orientation {
        public:
                dyn_edge_orientation_BFSMax(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
