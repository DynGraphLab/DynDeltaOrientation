...
dyn_edge_orientation_RWalkMax::dyn_edge_orientation_RWalkMax(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
...
void dyn_edge_orientation_RWalkMax::handleInsertion(NodeID source, NodeID target) {
...
void dyn_edge_orientation_RWalkMax::handleDeletion(NodeID source, NodeID target) {
...
bool dyn_edge_orientation_RWalkMax::rwalk(NodeID source) {
