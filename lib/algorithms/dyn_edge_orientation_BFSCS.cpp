...
dyn_edge_orientation_BFSCS::dyn_edge_orientation_BFSCS(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
...
void dyn_edge_orientation_BFSCS::handleInsertion(NodeID source, NodeID target) {
...
void dyn_edge_orientation_BFSCS::handleDeletion(NodeID source, NodeID target) {
...
void dyn_edge_orientation_BFSCS::bfs(NodeID source) {
