...
class dyn_edge_orientation_BFSCS : public dyn_edge_orientation {
        public:
                dyn_edge_orientation_BFSCS(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
