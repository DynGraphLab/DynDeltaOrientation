...
dyn_edge_orientation_naive_opt::dyn_edge_orientation_naive_opt(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
...
void dyn_edge_orientation_naive_opt::handleInsertion(NodeID source, NodeID target) {
...
void dyn_edge_orientation_naive_opt::handleDeletion(NodeID source, NodeID target) {
...
bool dyn_edge_orientation_naive_opt::bfs() {
        std::vector< NodeID > touched;
        std::queue< NodeID > bfsqueue;

        for( NodeID source :  m_degree_buckets[m_max_degree]) {
