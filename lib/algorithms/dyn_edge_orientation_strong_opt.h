#ifndef DELTA_ORIENTATIONS_strong_opt_H
#define DELTA_ORIENTATIONS_strong_opt_H
...
class dyn_edge_orientation_strong_opt : public dyn_edge_orientation {
public:
  dyn_edge_orientation_strong_opt(
...
private:
  ...
  void bfs_forward(NodeID source);
  void bfs_backward(NodeID target);
