#ifndef DELTA_ORIENTATIONS_naive_opt_H
#define DELTA_ORIENTATIONS_naive_opt_H
...
class dyn_edge_orientation_naive_opt : public dyn_edge_orientation {
        public:
                dyn_edge_orientation_naive_opt(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
