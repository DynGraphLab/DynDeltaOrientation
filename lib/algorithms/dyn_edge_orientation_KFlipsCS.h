#ifndef DELTA_ORIENTATIONS_KFLIPSCS_H
#define DELTA_ORIENTATIONS_KFLIPSCS_H
...
class dyn_edge_orientation_KFlipsCS : public dyn_edge_orientation {
        public:
                dyn_edge_orientation_KFlipsCS(const std::shared_ptr<dyn_graph_access>& GOrientation, const DeltaOrientationsConfig& config,
        ...
        private:
                ...
                std::vector< std::deque<NodeID> > m_adj;
                int m_max_degree;
